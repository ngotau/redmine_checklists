...
CHECKLISTS_VERSION_NUMBER = '3.0.1'
...
Redmine::Plugin.register :redmine_checklists do
  ...
  Redmine::AccessControl.map do |map|
    ...
    map.permission :create_checklists, {:checklist_config => [:create, :destroy, :update]}
  end
  ...
  Rails.configuration.to_prepare do
    ...
    unless ProjectsHelper.included_modules.include? CheckListProjectsHelperPatch
