...
Redmine.Checklist = $.klass({
  ...
  addChecklistFields: function() {
    ...
    var regexp = new RegExp("new_project_checklist", "g");
  ...
  onChecklistFormSubmitRemoveEmptyChecklistItems: function() {
    $('#checklist-form').on('submit', function(){
  ...
  init: function(element) {
    ...
    this.onChecklistFormSubmitRemoveEmptyChecklistItems()
...
function checklist_tracker() {
	tracker_id = $('#tracker').val()
	url = window.location.href.split('?')[0]+"?tracker="+tracker_id
